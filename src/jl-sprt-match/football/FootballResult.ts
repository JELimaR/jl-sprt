...
import { A_Result, IA_ResultInfo, TypeTotalScore } from '../../jl-sprt-core/Match/A_Result';

/**
 * Resultado de un partido de fútbol.
 * Score: number (goles). El ganador es quien tiene mayor cantidad de goles.
 */
export default class FootballResult extends A_Result<number> {
